...
Route::get('route-cache',[CacheController::class,'routeCache']);
Route::get('route-clear',[CacheController::class,'routeClear']);
Route::get('cache-clear',[CacheController::class,'cacheClear']);
Route::get('view-clear',[CacheController::class,'viewClear']);
...
//data - 27-5-2024
Route::get('/blog-listing', [WebsiteController::class, 'List']);
Route::get('/app-development',[WebsiteController::class,'Collection']);
Route::get('/blog-details', [WebsiteController::class, 'blog_detail']);
Route::get('/brand-identity',[WebsiteController::class,'brandIdentity']);
Route::get('/conversion-optimization',[WebsiteController::class,'conversionOptimization']);
Route::get('/copywriting',[WebsiteController::class,'copy_writing']);
Route::get('/digital-marketing',[WebsiteController::class,'digitalMarketing']);
Route::get('/e-commerce',[WebsiteController::class,'eCommerce']);
Route::get('/influencer',[WebsiteController::class,'Influencer']);
Route::get('/marketing-collatrals',[WebsiteController::class,'marketingCollatrals']);
Route::get('/pitch-deck',[WebsiteController::class,'pitchDeck']);
Route::get('/seo',[WebsiteController::class,'Seo']);
Route::get('/social-organic',[WebsiteController::class,'socialOrganic']);
Route::get('/strategy-consulting',[WebsiteController::class,'strategyConsulting']);
Route::get('/ui-ux-design',[WebsiteController::class,'uiUxDesign']);
Route::get('/video-and-motion-graphics',[WebsiteController::class,'videoAndMotionGraphics']);
Route::get('/web-development',[WebsiteController::class,'webDevelopment']);
//date 12-6-2024
