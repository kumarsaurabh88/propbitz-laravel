        ...
        <form action="{{ route("admin.course.update", [$course->id]) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name">Description*</label>
                 <textarea  name="description" rows="4" cols="50" class="form-control">{{$course->description}}
                     </textarea>
              ...
              <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                <label for="name">Course Curriculum*</label>
                 <textarea  name="curriculum" rows="4" cols="50" class="form-control">{{$course->curriculum}}
                     </textarea>
             ...
             <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                ...
                <input type="text" id="duration" name="duration" class="form-control" value="{{ old('duration', isset($course) ? $course->duration : '') }}" required>
            ...
            <div class="col-md-12 pl-0">
                <img src="{{ URL::to('/') }}/public/uploads/{{ $course->image }}" class="img-thumbnail" width="350px" height="300px" />
            </div>
            @endif
           <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
            ...
            @if(@$course->image1)
            <div class="col-md-12 pl-0">
                <img src="{{ URL::to('/') }}/public/uploads/{{ $course->image1 }}" class="img-thumbnail" width="400px" height="400px" />
            </div>
            @endif
            <div>
