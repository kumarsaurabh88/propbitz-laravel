...
class WebsiteController extends Controller
{
     ...
     public function about_us(){return view('website.about-us');}
     public function blog_detail() { return view('website.blog-details'); } 
     public function List(){ return view('website.blog-listing');}
     public function contact_us(){return view('website.contact-us');}
     public function error_page(){return view('website.error-page');}
     public function Login(){return view('website.login');}
     public function otp_varification(){return view('website.otp-varification');}
     public function property_details(){return view('website.property-details');}
     public function property_listing(){return view('website.property-listing');}
     public function Signup(){return view('website.signup');}  
     public function thank_you(){return view('website.thank-you');}
